...
SRER_L1_data <- read.csv("/Users/AlexiBesser/Desktop/SRER_LPI_L1_Spring_2025_Data.csv")
...
# create a data frame for rows with an "NA" for Top_height
...
# read in L0 csv files and create a new column for transect ID
JORN_L1_data <- readr::read_csv(JORN_L0_data_files, id = "Transect") %>%
   mutate(Transect = str_remove_all(Transect, ".csv"))
...
JORN_L1_data <- read.csv("/Users/AlexiBesser/Desktop/JORN_LPI_L1_Spring_2025_Data.csv")
...
write.csv(MOAB_L1_data, "/Users/AlexiBesser/Desktop/MOAB_LPI_L1_Spring_2025_Data.csv")
...
MOAB_L1_data <- read.csv("/Users/AlexiBesser/Desktop/MOAB_LPI_L1_Spring_2025_Data.csv")
...
write.csv(ONAQ_L1_data, "/Users/AlexiBesser/Desktop/ONAQ_LPI_L1_Spring_2025_Data.csv")
...
ONAQ_L1_data <- read.csv("/Users/AlexiBesser/Desktop/ONAQ_LPI_L1_Spring_2025_Data.csv")
